...
declare class AudioStream {
    ...
    * https://library.sannybuilder.com/#/sa?q=GET_AUDIO_STREAM_PROGRESS [2507]*/
    getProgress(): float;
    /** Gets the current playback progress of an audio stream in seconds irrespective of its speed (see 2505)
    *
    * https://library.sannybuilder.com/#/sa?q=GET_AUDIO_STREAM_PROGRESS_SECONDS [250B]*/
    getProgressSeconds(): float;
    /** Gets the playback speed multiplier of an audio stream
    *
    ...
    * https://library.sannybuilder.com/#/sa?q=GET_AUDIO_STREAM_STATE [0AB9]*/
    getState(): import('./enums').AudioStreamState;
    /** Gets the audio stream type (e.g. music, SFX)
    *
    * https://library.sannybuilder.com/#/sa?q=GET_AUDIO_STREAM_TYPE [2509]*/
    getType(): import('./enums').AudioStreamType;
    /** Gets the volume level of an audio stream (range 0.0 to 1.0)
    *
    ...
    * https://library.sannybuilder.com/#/sa?q=IS_AUDIO_STREAM_PLAYING [2500]*/
    isPlaying(): boolean;
    /** Releases/destroys an audio stream and frees its resources
    *
    ...
    * https://library.sannybuilder.com/#/sa?q=SET_AUDIO_STREAM_STATE [0AAD]*/
    setState(action: import('./enums').AudioStreamAction): AudioStream;
    /** Sets the audio stream type (e.g. music, SFX)
    *
    * https://library.sannybuilder.com/#/sa?q=SET_AUDIO_STREAM_TYPE [250A]*/
    setType(type: import('./enums').AudioStreamType): AudioStream;
    /** Sets the audio stream volume (default is 1.0). Pauses/Starts stream playback if necessary
    *
...
interface Camera {
    ...
    * https://library.sannybuilder.com/#/sa?q=GET_CURRENT_CAMERA_MODE [0E64]*/
    GetCurrentMode(): import('./enums').CameraMode;
...
declare class Car {
    ...
    * https://library.sannybuilder.com/#/sa?q=CLEAR_CAR_LAST_WEAPON_DAMAGE [0468]*/
    ...
    /** Sets a vehicle's engine state on (true) or off (false)
    *
    ...
    * https://library.sannybuilder.com/#/sa?q=DOES_CAR_HAVE_PART_NODE [0E82]*/
    doesHavePartNode(carNode: import('./enums').CarNode): boolean;
    ...
    * https://library.sannybuilder.com/#/sa?q=GET_CAR_COLLISION_SURFACE [0E90]*/
    getCollisionSurface(): import('./enums').SurfaceType;
    ...
    * https://library.sannybuilder.com/#/sa?q=GET_CAR_COLOURS [03F3]*/
    ...
    /** Finds and returns a pointer to a vehicle component (RwFrame) by its dummy name
    *
    * https://library.sannybuilder.com/#/sa?q=GET_CAR_COMPONENT [0D0D]*/
    getComponent(name: string): Component | undefined;
    /** Gets the world matrix (LTM) of a named vehicle component frame (e.g. wheel, door, bumper)
    *
    ...
    * https://library.sannybuilder.com/#/sa?q=GET_CAR_COORDINATES [00AA]*/
    ...
    /** Gets the current gear of a vehicle
    *
    ...
    * https://library.sannybuilder.com/#/sa?q=GET_CAR_DUMMY_COORD [0E5B]*/
    getDummyCoord(vehicleDummy: import('./enums').VehicleDummy, worldCoords: boolean, invertX: boolean): {
        x: float;
        y: float;
        z: float;
    } | undefined;
    ...
    * https://library.sannybuilder.com/#/sa?q=GET_EXTENDED_CAR_VAR [0E19]*/
    getExtendedCarVar(identifier: string, varNumber: int): unknown | undefined;
    ...
    * https://library.sannybuilder.com/#/sa?q=GET_NUM_CAR_COLOURS [097D]*/
    getNumColors(): int;
    /** Gets the number of gears of a vehicle from its handling data
    *
    ...
    * https://library.sannybuilder.com/#/sa?q=GET_VEHICLE_SUBCLASS [0E12]*/
    getSubclass(): import('./enums').VehicleSubclass;
    ...
    * https://library.sannybuilder.com/#/sa?q=IS_EMERGENCY_SERVICES_VEHICLE [0975]*/
    ...
    /** Checks if a vehicle's engine is currently running
    *
    * https://library.sannybuilder.com/#/sa?q=IS_CAR_ENGINE_ON [0ABE]*/
    isEngineOn(): boolean;
    ...
    * https://library.sannybuilder.com/#/sa?q=IS_CAR_SCRIPT_CONTROLLED [0E08]*/
    ...
    /** Checks if a vehicle's siren or alarm is currently active
    *
    * https://library.sannybuilder.com/#/sa?q=IS_CAR_SIREN_ON [0ABD]*/
    isSirenOn(): boolean;
    ...
    * https://library.sannybuilder.com/#/sa?q=SET_CAR_ALARM [0E61]*/
    setAlarm(status: import('./enums').CarAlarm): Car;
    ...
    * https://library.sannybuilder.com/#/sa?q=SET_CAN_RESPRAY_CAR [0294]*/
    ...
    /** Sets the alpha (transparency) for a specific named vehicle component model
    *
    ...
    * https://library.sannybuilder.com/#/sa?q=SET_CAR_DOOR_WINDOW_STATE [0D33]*/
    setDoorWindowState(door: import('./enums').CarNodeDoor, state: boolean): Car;
    ...
    * https://library.sannybuilder.com/#/sa?q=SET_EXTENDED_CAR_VAR [0E18]*/
    setExtendedVar(identifier: string, varNumber: int, value: unknown): boolean;
...
declare class Char {
    ...
    * https://library.sannybuilder.com/#/sa?q=DOES_CHAR_EXIST [056D]*/
    static DoesExist(handle: unknown): boolean;
    static GetBoneOffsetVector(pedBone: import('./enums').PedBone): int;
    ...
    * https://library.sannybuilder.com/#/sa?q=CLEAR_CHAR_TASKS_IMMEDIATELY [0792]*/
    ...
    createRenderObjectToCharBoneFromSpecial(specialModel: int, pedBone: import('./enums').PedBone, x: float, y: float, z: float, rx: float, ry: float, rz: float): int;
    ...
    * https://library.sannybuilder.com/#/sa?q=GET_CHAR_ARMOUR [04DD]*/
    getArmor(): int;
    getBone(pedBone: import('./enums').PedBone): int | undefined;
    ...
    * https://library.sannybuilder.com/#/sa?q=GET_CHAR_BONE_MATRIX [0D0B]*/
    getBoneMatrix(pedBone: import('./enums').PedBone): int | undefined;
    ...
    * https://library.sannybuilder.com/#/sa?q=GET_CHAR_DAMAGE_LAST_FRAME [0EB5]*/
    getDamageLastFrame(): {
        entity: Char;
        weaponType: import('./enums').WeaponType;
        bodyPart: import('./enums').BodyPart;
        intensity: float;
    } | undefined;
    ...
    * https://library.sannybuilder.com/#/sa?q=GET_EXTENDED_CHAR_VAR [0E16]*/
    getExtendedVar(identifier: string, varNumber: int): unknown | undefined;
    ...
    * https://library.sannybuilder.com/#/sa?q=GET_CHAR_MODEL [0665]*/
    getModel(): int;
    getMoveState(): import('./enums').MoveState;
    ...
    * https://library.sannybuilder.com/#/sa?q=GET_CHAR_PEDSTATE [0EAB]*/
    getPedState(): import('./enums').PedState;
    ...
    * https://library.sannybuilder.com/#/sa?q=GET_CHAR_STAT_ID [0EB1]*/
    getStatId(): import('./enums').PedStat;
    ...
    * https://library.sannybuilder.com/#/sa?q=GET_CHAR_TASK_POINTER_BY_ID [0E43]*/
    getTaskPointerById(taskId: import('./enums').TaskId): int | undefined;
    ...
    * https://library.sannybuilder.com/#/sa?q=GET_CHAR_WEAPON_STATE [0E8B]*/
    getWeaponState(): import('./enums').WeaponState;
    ...
    * https://library.sannybuilder.com/#/sa?q=IS_CHAR_DOING_ANY_IMPORTANT_TASK [0E4C]*/
    isDoingAnyImportantTask(includeAnims: boolean): boolean;
    ...
    * https://library.sannybuilder.com/#/sa?q=IS_CHAR_DOING_TASK_ID [0E42]*/
    isDoingTaskId(taskId: import('./enums').TaskId): boolean;
    ...
    * https://library.sannybuilder.com/#/sa?q=IS_CHAR_PLAYING_ANY_SCRIPT_ANIMATION [0E4B]*/
    isPlayingAnyScriptAnimation(includeAnims: boolean): boolean;
...
declare class CleoBlip {
    ...
    * https://library.sannybuilder.com/#/sa?q=ADD_CLEO_BLIP [0E2A]*/
    static Add(rwTextureOrRadarSprite: unknown, x: float, y: float, short: boolean, red: int, green: int, blue: int, alpha: int): CleoBlip;
    /** Removes a cleo blip
    *
...
declare class ColPoint {
    ...
    * https://library.sannybuilder.com/#/sa?q=GET_COLLISION_BETWEEN_POINTS [0D3A]*/
    static GetCollisionBetweenPoints(fromX: float, fromY: float, fromZ: float, toX: float, toY: float, toZ: float, buildings: boolean, vehicles: boolean, peds: boolean, objects: boolean, dummies: boolean, seeThroughCheck: boolean, cameraIgnoreCheck: boolean, shotThroughCheck: boolean, entityToIgnore: int): {
        handle: ColPoint;
        outX: float;
        outY: float;
        outZ: float;
...
interface Debugger {
    /** Pauses script execution at a breakpoint, can be continued with F5-F12 keys
    *
...
interface Entity {
    ...
    * https://library.sannybuilder.com/#/sa?q=GET_ENTITY_TYPE [0E13]*/
    GetType(entity: unknown): import('./enums').EntityType;
...
declare class File {
    ...
    * https://library.sannybuilder.com/#/sa?q=OPEN_FILE [0A9A]*/
    ...
    /** Closes an open file by its handle
    *
    * https://library.sannybuilder.com/#/sa?q=CLOSE_FILE [0A9B]*/
    close(): void;
    /** Gets the current read/write position within an open file
    *
    * https://library.sannybuilder.com/#/sa?q=GET_FILE_POSITION [2300]*/
    getPosition(): int;
    /** Gets the size in bytes of an open file
    *
    ...
    * https://library.sannybuilder.com/#/sa?q=READ_FROM_FILE [0A9D]*/
    read(size: int): int;
    /** Reads a block of raw binary data from a file into a buffer
    *
    ...
    * https://library.sannybuilder.com/#/sa?q=READ_STRING_FROM_FILE [0AD7]*/
    ...
    /** Scans/parses content from a file using sscanf-style format
    *
    * https://library.sannybuilder.com/#/sa?q=SCAN_FILE [0ADA]*/
    ...
    /** Seeks to a position in an open file (sets the file pointer offset)
    *
    * https://library.sannybuilder.com/#/sa?q=FILE_SEEK [0AD5]*/
    seek(offset: int, origin: import('./enums').SeekOrigin): boolean;
    ...
    * https://library.sannybuilder.com/#/sa?q=WRITE_TO_FILE [0A9E]*/
    ...
    /** Writes a block of raw binary data from a buffer to a file
    *
    * https://library.sannybuilder.com/#/sa?q=WRITE_BLOCK_TO_FILE [2302]*/
    writeBlock(size: int, address: int): boolean;
    /** Writes a formatted string to a file using printf-style format
    *
...
declare class FindFile {
    constructor(handle: number);
    /** Finds the first file/directory matching a search pattern, returns name and handle
    *
    * https://library.sannybuilder.com/#/sa?q=FIND_FIRST_FILE [0AE6]*/
    ...
    /** Closes a file search handle opened with FIND_FIRST_FILE
    *
    * https://library.sannybuilder.com/#/sa?q=FIND_CLOSE [0AE8]*/
    close(): FindFile;
    /** Finds the next file/directory in a search started with FIND_FIRST_FILE
    *
...
interface Fs {
    /** Copies a directory and all its contents and returns true if the operation is successful
    *
    * https://library.sannybuilder.com/#/sa?q=COPY_DIRECTORY [0B05]*/
    CopyDirectory(dirPath: string, newDirPath: string): boolean;
    /** Copies a file and returns true if the operation is successful
    *
    ...
    * https://library.sannybuilder.com/#/sa?q=GET_SCRIPT_FILENAME [2304]*/
    ...
    /** Moves or renames a directory and returns true if the operation is successful
    *
    * https://library.sannybuilder.com/#/sa?q=MOVE_DIRECTORY [0B03]*/
    MoveDirectory(dirPath: string, newDirPath: string): boolean;
    /** Moves or renames a file and returns true if the operation is successful
    *
    * https://library.sannybuilder.com/#/sa?q=MOVE_FILE [0B02]*/
    MoveFile(fileName: string, newFileName: string): boolean;
    /** Resolves absolute filepath. Input path can be relative, start with a 'virtual path' prefix or be already absolute filepath
    *
...
interface Game {
    ...
    * https://library.sannybuilder.com/#/sa?q=GET_MAX_WANTED_LEVEL [050F]*/
    ...
    /** Gets the current platform identifier (e.g. PC, Android, Xbox)
    *
    * https://library.sannybuilder.com/#/sa?q=GET_PLATFORM [0DD5]*/
    GetPlatform(): import('./enums').Platform;
    ...
    * https://library.sannybuilder.com/#/sa?q=IS_CHEAT_ACTIVE [0E5D]*/
    IsCheatActive(cheat: import('./enums').Cheats): boolean;
...
interface Hud {
    ...
    * https://library.sannybuilder.com/#/sa?q=DISPLAY_ONSCREEN_COUNTER_LOCAL [0E50]*/
    DisplayCounterLocal(timer: int, display: import('./enums').CounterDisplay): void;
    ...
    * https://library.sannybuilder.com/#/sa?q=DISPLAY_ONSCREEN_COUNTER_WITH_STRING_LOCAL [0E51]*/
    DisplayCounterWithStringLocal(counter: int, display: import('./enums').CounterDisplay, text: string): void;
    ...
    * https://library.sannybuilder.com/#/sa?q=DISPLAY_ONSCREEN_TIMER_LOCAL [0E4E]*/
    DisplayTimerLocal(timer: int, direction: import('./enums').TimerDirection): void;
    ...
    * https://library.sannybuilder.com/#/sa?q=DISPLAY_ONSCREEN_TIMER_WITH_STRING_LOCAL [0E4F]*/
    DisplayTimerWithStringLocal(timer: int, direction: import('./enums').TimerDirection, text: string): void;
    ...
    * https://library.sannybuilder.com/#/sa?q=SET_ONSCREEN_COUNTER_COLOUR_LOCAL [0E58]*/
    SetCounterColorLocal(counter: int, color: import('./enums').HudColors): void;
...
interface ImGui {
    ...
    * https://library.sannybuilder.com/#/sa?q=IMGUI_ARROW_BUTTON [221C]*/
    ButtonArrow(name: string, imGuiDir: import('./enums').ImGuiDir): boolean;
...
interface IniFile {
    /** Deletes a specific key from an INI file section
    *
...
interface Math {
    ...
    * https://library.sannybuilder.com/#/sa?q=CLAMP_INT [0EF7]*/
    ...
    /** Clears a specific bit (by index 0-31) in an integer variable to 0
    *
    ...
    * https://library.sannybuilder.com/#/sa?q=EASE [0E1F]*/
    Ease(k: float, mode: import('./enums').EaseMode, way: import('./enums').EaseWay): float;
    ...
    * https://library.sannybuilder.com/#/sa?q=GET_HEADING_FROM_VECTOR_2D [0604]*/
    ...
    /** Checks if a specific bit (by index 0-31) is set in an integer value
    *
    * https://library.sannybuilder.com/#/sa?q=IS_BIT_SET [2700]*/
    IsBitSet(number: int, bitIndex: int): boolean;
    /** Checks if a value is truthy (non-zero, non-empty string), sets condition flag
    *
    ...
    * https://library.sannybuilder.com/#/sa?q=PERLIN_NOISE_FRACTAL_3D [0EF2]*/
    ...
    /** Returns true with a given percentage chance (0.0-100.0)
    *
    ...
    * https://library.sannybuilder.com/#/sa?q=RANDOM_PERCENT [0E4D]*/
    ...
    /** Picks a random text string from a list of provided values
    *
    * https://library.sannybuilder.com/#/sa?q=PICK_RANDOM_TEXT [2707]*/
    RandomPick(...values: number[]): string;
    /** Sets a specific bit (by index 0-31) in an integer variable to 1
    *
    ...
    * https://library.sannybuilder.com/#/sa?q=SIGN_EXTEND [0B1E]*/
    ...
    /** Sets or clears a specific bit (by index 0-31) in an integer variable based on state
    *
...
declare class Matrix {
    constructor(handle: number);
    /** Multiplies two RwMatrix matrices: result = matrixA * matrixB
    *
    * https://library.sannybuilder.com/#/sa?q=MULTIPLY_MATRICES [0D00]*/
    static Multiply(matrixA: Matrix, matrixB: Matrix): Matrix;
    /** Copies all 16 elements of one RwMatrix to another (deep copy)
    *
    * https://library.sannybuilder.com/#/sa?q=COPY_MATRIX [0D09]*/
    copy(destination: Matrix): Matrix;
    /** Transforms a local offset vector into world-space coordinates using the matrix
    *
    * https://library.sannybuilder.com/#/sa?q=GET_OFFSET_FROM_MATRIX_IN_WORLD_COORDS [0D0A]*/
    ...
    /** Gets the X (right vector) Euler angle of a matrix in degrees
    *
    * https://library.sannybuilder.com/#/sa?q=GET_MATRIX_X_ANGLE [0D02]*/
    getXAngle(): float;
    /** Gets the Y (up vector) Euler angle of a matrix in degrees
    *
    * https://library.sannybuilder.com/#/sa?q=GET_MATRIX_Y_ANGLE [0D03]*/
    getYAngle(): float;
    /** Gets the Z (at vector) Euler angle of a matrix in degrees
    *
    * https://library.sannybuilder.com/#/sa?q=GET_MATRIX_Z_ANGLE [0D04]*/
    getZAngle(): float;
    /** Sets the rotation of a matrix from Euler angles (pitch, yaw, roll in degrees) while preserving its position
    *
    * https://library.sannybuilder.com/#/sa?q=SET_MATRIX_ROTATION [0D08]*/
    rotate(x: float, y: float, z: float): Matrix;
    /** Rotates a matrix around a specified axis vector by an angle (degrees) using the given combine operation (RwOpCombineType)
    *
    * https://library.sannybuilder.com/#/sa?q=ROTATE_MATRIX_ON_AXIS [0D01]*/
    rotateOnAxis(axisX: float, axisY: float, axisZ: float, angle: float, combineOp: import('./enums').RwCombine): Matrix;
    /** Sets the position (translation) component of a matrix from X, Y, Z coordinates
    *
    * https://library.sannybuilder.com/#/sa?q=SET_MATRIX_POSITION [0D05]*/
    setPosition(x: float, y: float, z: float): Matrix;
}
/** 
 * 
...
interface Memory {
    ...
    * https://library.sannybuilder.com/#/sa?q=ALLOC_NEAR */
    ...
    /** Allocates a block of memory of specified size and returns its address
    *
    ...
    * https://library.sannybuilder.com/#/sa?q=GET_THIS_SCRIPT_STRUCT [0A9F]*/
    ...
    /** Gets the memory address/pointer of a script variable (local or global)
    *
    ...
    * https://library.sannybuilder.com/#/sa?q=GET_VEHICLE_REF [0AEB]*/
    ...
    /** Compares two blocks of memory for equality and returns true if they match
    *
    * https://library.sannybuilder.com/#/sa?q=IS_MEMORY_EQUAL [2407]*/
    IsEqual(addressA: int, addressB: int, size: int): boolean;
    /** Checks if address points at a valid and running script
    *
    ...
    * https://library.sannybuilder.com/#/sa?q=READ_STRUCT_OFFSET [0D4E]*/
    ReadStructOffset(address: int, offset: int, size: int): unknown;
    ...
    * https://library.sannybuilder.com/#/sa?q=READ_STRUCT_PARAM [0D38]*/
    ReadStructParam(address: int, index: int): int;
    /** Reads memory at a base address with a byte offset
    *
    ...
    * https://library.sannybuilder.com/#/sa?q=WRITE_STRUCT_PARAM [0D37]*/
    WriteStructParam(address: int, index: int, value: int): void;
    /** Writes a value to memory at a base address with a byte offset
    *
    * https://library.sannybuilder.com/#/sa?q=WRITE_MEMORY_WITH_OFFSET [2402]*/
    WriteWithOffset(address: int, offset: int, size: int, value: unknown): void;
}
...
interface Pad {
    /** Emulates/simulates a key press event for a virtual key code
    *
    * https://library.sannybuilder.com/#/sa?q=EMULATE_KEY_PRESS [2083]*/
    EmulateKeyPress(keyCode: import('./enums').KeyCode): void;
    /** Emulates/simulates a key release event for a virtual key code
    *
    * https://library.sannybuilder.com/#/sa?q=EMULATE_KEY_RELEASE [2084]*/
    EmulateKeyRelease(keyCode: import('./enums').KeyCode): void;
    ...
    * https://library.sannybuilder.com/#/sa?q=GET_CONTROLLER_KEY [2085]*/
    GetControllerKey(action: import('./enums').ControllerAction, altKey: import('./enums').ControllerAltKey): import('./enums').KeyCode | undefined;
    /** Returns the controller mode
    *
    * https://library.sannybuilder.com/#/sa?q=GET_CONTROLLER_MODE [0293]*/
    GetControllerMode(): unknown;
    /** Checks if any key from a range was just pressed this frame
    *
    * https://library.sannybuilder.com/#/sa?q=GET_KEY_JUST_PRESSED_IN_RANGE [2082]*/
    GetKeyJustPressedInRange(minKeyCode: import('./enums').KeyCode, maxKeyCode: import('./enums').KeyCode): import('./enums').KeyCode | undefined;
    ...
    * https://library.sannybuilder.com/#/sa?q=GET_KEY_NAME [2086]*/
    GetKeyName(keyCode: import('./enums').KeyCode): string | undefined;
    /** Checks if any key from a range of virtual key codes is currently held
    *
    * https://library.sannybuilder.com/#/sa?q=GET_KEY_PRESSED_IN_RANGE [2081]*/
    GetKeyPressedInRange(minKeyCode: import('./enums').KeyCode, maxKeyCode: import('./enums').KeyCode): import('./enums').KeyCode | undefined;
    ...
    * https://library.sannybuilder.com/#/sa?q=GET_TIME_NOT_TOUCHING_PAD [0F13]*/
    GetTimeNotTouching(pad: import('./enums').PadId): int;
    ...
    * https://library.sannybuilder.com/#/sa?q=IS_AIM_BUTTON_PRESSED [0E67]*/
    IsAimButtonPressed(pad: import('./enums').PadId): boolean;
    ...
    * https://library.sannybuilder.com/#/sa?q=IS_ANY_FIRE_BUTTON_PRESSED [0E8D]*/
    IsAnyFireButtonPressed(pad: import('./enums').PadId): boolean;
    ...
    * https://library.sannybuilder.com/#/sa?q=IS_BUTTON_JUST_PRESSED [0E3E]*/
    IsButtonJustPressed(pad: import('./enums').PadId, buttonId: import('./enums').Button): boolean;
    ...
    * https://library.sannybuilder.com/#/sa?q=IS_KEY_DOWN */
    ...
    /** Checks if a virtual key was just pressed this frame (not held)
    *
    * https://library.sannybuilder.com/#/sa?q=IS_KEY_JUST_PRESSED [2080]*/
    IsKeyJustPressed(keyCode: import('./enums').KeyCode): boolean;
    ...
    * https://library.sannybuilder.com/#/sa?q=SET_PLAYER_CONTROL_PAD [0E68]*/
    SetControl(pad: import('./enums').PadId, enabled: boolean): void;
    ...
    * https://library.sannybuilder.com/#/sa?q=SET_PLAYER_CONTROL_PAD_MOVEMENT [0E69]*/
    SetMovement(pad: import('./enums').PadId, movement: boolean): void;
...
declare class Pickup {
    ...
    * https://library.sannybuilder.com/#/sa?q=GET_PICKUP_TYPE [0E39]*/
    getType(): import('./enums').PickupType;
...
declare class Player {
    ...
    * https://library.sannybuilder.com/#/sa?q=CHANGE_PLAYER_MONEY [0E5E]*/
    changeMoney(mode: import('./enums').ChangeMoney, value: int): Player;
    ...
    * https://library.sannybuilder.com/#/sa?q=GET_PLAYER_CHAR [01F5]*/
    getChar(): Char;
    /** Gets the character (ped) handle that the specified player is currently targeting
    *
    * https://library.sannybuilder.com/#/sa?q=GET_CHAR_PLAYER_IS_TARGETING [0AD2]*/
...
declare class RenderObject {
    ...
    * https://library.sannybuilder.com/#/sa?q=CREATE_RENDER_OBJECT_TO_CHAR_BONE [0E2E]*/
    static CreateToCharBone(char: Char, modelId: int, pedBone: import('./enums').PedBone, x: float, y: float, z: float, rx: float, ry: float, rz: float): RenderObject;
...
declare class SampBitstream {
    ...
    * https://library.sannybuilder.com/#/sa?q=SAMP_RAKNET_BITSTREAM_EMULATE_AS_INCOMING_PACKET [0BF7]*/
    emulateAsPacketIn(id: import('./enums').SampPacket): boolean;
    ...
    * https://library.sannybuilder.com/#/sa?q=SAMP_RAKNET_BITSTREAM_EMULATE_AS_INCOMING_RPC [0BF6]*/
    emulateAsRpcIn(id: import('./enums').SampRpc): boolean;
    ...
    * https://library.sannybuilder.com/#/sa?q=SAMP_RAKNET_BITSTREAM_READ [0BE7]*/
    read(dataType: import('./enums').SampBitStreamDataType): unknown | undefined;
    ...
    * https://library.sannybuilder.com/#/sa?q=SAMP_RAKNET_SEND_PACKET_WITH_PARAMS [0B42]*/
    sendAsPacketWithParams(priority: import('./enums').SampPriority, reliability: import('./enums').SampReliability, orderingChannel: int): boolean;
    /** Sends BitStream as RPC to Server
    *
    * https://library.sannybuilder.com/#/sa?q=SAMP_RAKNET_SEND_RPC [0B8A]*/
    sendAsRpc(rpcId: import('./enums').SampRpc): boolean;
    ...
    * https://library.sannybuilder.com/#/sa?q=SAMP_RAKNET_SEND_RPC_WITH_PARAMS [0B41]*/
    sendAsRpcWithParams(rpc: import('./enums').SampRpc, priority: import('./enums').SampPriority, reliability: import('./enums').SampReliability, orderingChannel: int, shiftTimeStamp: int): boolean;
    ...
    * https://library.sannybuilder.com/#/sa?q=SAMP_RAKNET_BITSTREAM_WRITE [0B40]*/
    write(value: unknown, dataType: import('./enums').SampBitStreamDataType, dataSize: int): boolean;
}
/** SAMP chat system
 * 
...
interface SampChat {
    ...
    * https://library.sannybuilder.com/#/sa?q=SAMP_GET_CHAT_DISPLAY_MODE [0BDC]*/
    GetDisplayMode(): import('./enums').SampChatDisplayMode;
    ...
    * https://library.sannybuilder.com/#/sa?q=SAMP_SET_CHAT_DISPLAY_MODE [0BDD]*/
    SetDisplayMode(mode: import('./enums').SampChatDisplayMode): void;
...
/** SAMP main class
 * 
 * https://library.sannybuilder.com/#/sa/classes/SampClient */
interface SampClient {
    ...
    * https://library.sannybuilder.com/#/sa?q=SAMP_CLOSE_ACTIVE_DIALOG_WITH_BUTTON [0B47]*/
    CloseDialog(button: import('./enums').SampDialogButton): boolean;
    ...
    * https://library.sannybuilder.com/#/sa?q=SAMP_GET_CURSOR_MODE [0B8E]*/
    GetCursorMode(): import('./enums').SampCursorMode | undefined;
    ...
    * https://library.sannybuilder.com/#/sa?q=SAMP_GET_DIALOG_STYLE [0B4D]*/
    GetDialogStyle(): import('./enums').SampDialogStyle | undefined;
    ...
    * https://library.sannybuilder.com/#/sa?q=SAMP_GET_GAMESTATE [0B4F]*/
    GetGamestate(): import('./enums').SampGameState;
    ...
    * https://library.sannybuilder.com/#/sa?q=SAMP_READ_SAMP_MEMORY_WITH_OFFSET [0B2E]*/
    ReadMemoryWithOffset(offset: int, size: int): unknown;
    ...
    * https://library.sannybuilder.com/#/sa?q=SAMP_SET_CURSOR_MODE [0B8D]*/
    SetCursorMode(mode: import('./enums').SampCursorMode): void;
    ...
    * https://library.sannybuilder.com/#/sa?q=SAMP_SET_GAMESTATE [0B27]*/
    SetGameState(id: import('./enums').SampGameState): void;
    ...
    * https://library.sannybuilder.com/#/sa?q=SAMP_SET_SEND_RATE [0B22]*/
    SetSendRate(type: import('./enums').SampSendRateType, delay: int): void;
    /** Sets the special action for our Player
    *
    * https://library.sannybuilder.com/#/sa?q=SAMP_SET_SPECIAL_ACTION [0AFD]*/
    SetSpecialAction(id: import('./enums').SampSpecialAction): void;
    ...
    * https://library.sannybuilder.com/#/sa?q=SAMP_SHOW_DIALOG [0B3B]*/
    ShowDialog(id: int, title: string, content: string, leftOrMiddleButtonName: string, rightButtonName: string, style: import('./enums').SampDialogStyle): void;
    /** Writes the value with size to samp.dll+offset
    *
    * https://library.sannybuilder.com/#/sa?q=SAMP_WRITE_SAMP_MEMORY_WITH_OFFSET [0B2D]*/
    WriteMemoryWithOffset(offset: int, value: unknown, size: int): void;
}
declare var SampClient: SampClient
/** SAMP local chat commands
 * 
...
interface SampPlayer {
    ...
    * https://library.sannybuilder.com/#/sa?q=SAMP_GET_PLAYER_SPECIAL_ACTION [0B62]*/
    getSpecialAction(): import('./enums').SampSpecialAction | undefined;
...
interface SampRaknet {
    ...
    * https://library.sannybuilder.com/#/sa?q=SAMP_FORCE_PASSENGER_SYNC [0C86]*/
    ForcePassengerSync(carId: int, seatId: import('./enums').SeatId): void;
    ...
    * https://library.sannybuilder.com/#/sa?q=SAMP_FORCE_UNOCCUPIED_SYNC [0C82]*/
    ForceUnnocupiedSync(carId: int, seatId: import('./enums').SeatId): void;
    ...
    * https://library.sannybuilder.com/#/sa?q=SAMP_RAKNET_HOOK_GET_PARAM [0BE5]*/
    GetHookParam(type: import('./enums').SampRakNetHookParam): unknown | undefined;
    ...
    * https://library.sannybuilder.com/#/sa?q=SAMP_SEND_AIM_DATA [0BC3]*/
    SendPktAimData(payloadPointer: int): void;
    ...
    * https://library.sannybuilder.com/#/sa?q=SAMP_SEND_BULLET_DATA [0BC4]*/
    SendPktBulletData(payloadPointer: int): void;
    ...
    * https://library.sannybuilder.com/#/sa?q=SAMP_SEND_DRIVING_DATA [0BC1]*/
    SendPktDrivingData(payloadPointer: int): void;
    ...
    * https://library.sannybuilder.com/#/sa?q=SAMP_SEND_ONFOOT_DATA [0BC0]*/
    SendPktOnFootData(payloadPointer: int): void;
    ...
    * https://library.sannybuilder.com/#/sa?q=SAMP_SEND_PASSENGER_DATA [0BC2]*/
    SendPktPassengerData(payloadPointer: int): void;
    ...
    * https://library.sannybuilder.com/#/sa?q=SAMP_SEND_SPECTATOR_DATA [0BC7]*/
    SendPktSpectatorData(payloadPointer: int): void;
    ...
    * https://library.sannybuilder.com/#/sa?q=SAMP_SEND_TRAILER_DATA [0BC5]*/
    SendPktTrailerData(payloadPointer: int): void;
    ...
    * https://library.sannybuilder.com/#/sa?q=SAMP_SEND_UNOCCUPIEDCAR_DATA [0BC6]*/
    SendPktUnoccupiedCarData(payloadPointer: int): void;
    ...
    * https://library.sannybuilder.com/#/sa?q=SAMP_SEND_DEATH_BY_PLAYER [0AFE]*/
    SendRpcDeath(playerId: int, weaponId: import('./enums').WeaponType): void;
    /** Sends an SampRpc.DialogResponse to the server
    *
    * https://library.sannybuilder.com/#/sa?q=SAMP_SEND_DIALOG_RESPONSE [0BC9]*/
    SendRpcDialogResponse(dialogId: int, whichButton: import('./enums').SampDialogButton, itemId: int, inputText: string): void;
    ...
    * https://library.sannybuilder.com/#/sa?q=SAMP_SEND_DISCONNECTED [0B28]*/
    SendRpcDisconnected(id: import('./enums').SampDisconnectReason): void;
    ...
    * https://library.sannybuilder.com/#/sa?q=SAMP_SEND_EDIT_ATTACHED_OBJECT [0BCE]*/
    SendRpcEditAttachedObject(response: import('./enums').SampEditObjectResponse, index: int, model: int, pedBone: import('./enums').PedBone, offsetX: float, offsetY: float, offsetZ: float, pitch: float, roll: float, yaw: float, scaleX: float, scaleY: float, scaleZ: float): void;
    ...
    * https://library.sannybuilder.com/#/sa?q=SAMP_SEND_EDIT_OBJECT [0BCD]*/
    SendRpcEditObject(isLocalObject: boolean, id: int, response: import('./enums').SampEditObjectResponse, coordX: float, coordY: float, coordZ: float, pitch: float, roll: float, yaw: float): void;
    ...
    * https://library.sannybuilder.com/#/sa?q=SAMP_SEND_GIVE_DAMAGE [0BCB]*/
    SendRpcGiveDamage(playerId: int, floatDamage: import('./enums').SampWeaponDamage, weapon: import('./enums').WeaponType, bodyPart: import('./enums').BodyPart): void;
    ...
    * https://library.sannybuilder.com/#/sa?q=SAMP_SEND_SCM_EVENT [0AFC]*/
    SendRpcScmEvent(carId: int, type: import('./enums').SampScmEvent, param1: int, param2: int): void;
    ...
    * https://library.sannybuilder.com/#/sa?q=SAMP_SEND_TAKE_DAMAGE [0BCC]*/
    SendRpcTakeDamage(playerId: int, floatDamage: import('./enums').SampWeaponDamage, weapon: import('./enums').WeaponType, bodyPart: import('./enums').SampBodyPart): void;
    ...
    * https://library.sannybuilder.com/#/sa?q=SAMP_RAKNET_SET_HOOK_PARAM [0BE6]*/
    SetHookParam(type: import('./enums').SampRakNetHookParam, value: unknown): boolean;
}
...
interface SampTextDraw {
    ...
    * https://library.sannybuilder.com/#/sa?q=SAMP_GET_TEXTDRAW_ALIGNMENT [0C54]*/
    getAlignment(): import('./enums').SampTextDrawAlignment | undefined;
    ...
    * https://library.sannybuilder.com/#/sa?q=SAMP_SET_TEXTDRAW_ALIGNMENT [0C4A]*/
    setAlignment(alignment: import('./enums').SampTextDrawAlignment): boolean;
...
declare class SampTextLabel3D {
    ...
    * https://library.sannybuilder.com/#/sa?q=SAMP_CREATE_3D_TEXT [0B44]*/
    static Create(text: string, color: int, coordX: float, coordY: float, coordZ: float, visibilityRadius: float, showBehindWalls: boolean, attachedPlayerId: int, attachedCarId: int): SampTextLabel3D | undefined;
    /** Creates/overwrites a 3D text with the specified ID
    *
    * https://library.sannybuilder.com/#/sa?q=SAMP_CREATE_3D_TEXT_WITH_ID [0C45]*/
    static CreateWithId(idAsHandle: SampTextLabel3D, text: int, color: int, coordX: float, coordY: float, coordZ: float, visibilityRadius: float, showBehindWalls: boolean, attachedPlayerId: int, attachedCarId: int): void;
...
declare class ScriptObject {
    ...
    * https://library.sannybuilder.com/#/sa?q=SIMULATE_OBJECT_DAMAGE [0E95]*/
    simulateDamage(damage: float, weaponType: import('./enums').WeaponType): ScriptObject;
...
interface Sf {
    ...
    * https://library.sannybuilder.com/#/sa?q=SF_KEY_JUST_PRESSED [0C89]*/
    KeyJustPressed(keyCode: import('./enums').KeyCode): boolean;
    ...
    * https://library.sannybuilder.com/#/sa?q=SF_READ_ELEMENT_OF_4BYTES_ARRAY [0C0E]*/
    ReadElementOf4BytesArray(array: int, index: int): unknown | undefined;
    ...
    * https://library.sannybuilder.com/#/sa?q=SF_READ_ELEMENT_OF_SIZED_ARRAY [0C1D]*/
    ReadElementOfSizedArray(array: int, index: int, size: int): unknown | undefined;
    ...
    * https://library.sannybuilder.com/#/sa?q=SF_READ_MEMORY_WITH_OFFSET [0C0C]*/
    ReadMemoryWithOffset(address: int, offset: int, size: int): unknown | undefined;
    ...
    * https://library.sannybuilder.com/#/sa?q=SF_SET_BUTTON [0B56]*/
    SetButton(buttonId: import('./enums').Button, behaviorValue: int): void;
    ...
    * https://library.sannybuilder.com/#/sa?q=SF_SET_KEY_STATUS [0C72]*/
    SetKeyStatus(keyCode: import('./enums').KeyCode, isPressed: boolean): void;
    ...
    * https://library.sannybuilder.com/#/sa?q=SF_STRING_POINTER [0C3A]*/
    StrPtr(variable: int, string: string, ...unused: number[]): void;
    ...
    * https://library.sannybuilder.com/#/sa?q=SF_WRITE_ELEMENT_OF_4BYTES_ARRAY [0C0F]*/
    WriteElementOf4BytesArray(array: int, index: int, value: unknown): boolean;
    ...
    * https://library.sannybuilder.com/#/sa?q=SF_WRITE_ELEMENT_OF_SIZED_ARRAY [0C1E]*/
    WriteElementOfSizedArray(array: int, index: int, size: int, value: unknown): boolean;
    ...
    * https://library.sannybuilder.com/#/sa?q=SF_WRITE_MEMORY_WITH_OFFSET [0C0D]*/
    WriteMemoryWithOffset(address: int, offset: int, size: int, value: unknown): boolean;
...
declare class SfD3DFont {
    constructor(handle: number);
    /** Creates a D3DFont Object
    *
    * https://library.sannybuilder.com/#/sa?q=SF_D3D_CREATE_FONT [0B6D]*/
    static Create(fontName: string, size: int, styleFlags: import('./enums').SampTextStyle): SfD3DFont;
    ...
    * https://library.sannybuilder.com/#/sa?q=SF_D3D_DRAW_TEXT_WITH_FONT [0B6F]*/
    drawText(text: string, coordX: int, coordY: int, color: int): SfD3DFont;
...
declare class SfD3DTexture {
    ...
    * https://library.sannybuilder.com/#/sa?q=SF_D3D_LOAD_TEXTURE_FROM_FILE_IN_MEMORY [0C8C]*/
    static LoadTextureFromFileMemory(buffer: int, bufferSize: int): SfD3DTexture | undefined;
    /** Draws the texture on the screen
    *
    * https://library.sannybuilder.com/#/sa?q=SF_D3D_DRAW_TEXTURE [0B73]*/
    draw(coordX: int, coordY: int, width: int, height: int, heading: float, contrast: int): SfD3DTexture;
...
declare class SfDxutDialog {
    ...
    * https://library.sannybuilder.com/#/sa?q=SF_DXUT_DIALOG_DELETE_CONTROL [0BA3]*/
    deleteControl(id: int): SfDxutDialog;
    ...
    * https://library.sannybuilder.com/#/sa?q=SF_DXUT_DIALOG_SET_BACKGROUND_COLOR [0B93]*/
    setBgColor(color: int): SfDxutDialog;
    ...
    * https://library.sannybuilder.com/#/sa?q=SF_DXUT_DIALOG_SET_COORDS_OF_CONTROL [0BA8]*/
    setControlCoords(id: int, relCoordX: int, relCoordY: int): SfDxutDialog;
    ...
    * https://library.sannybuilder.com/#/sa?q=SF_DXUT_DIALOG_SET_COORDS_AND_DIMS [0B84]*/
    setCoordsAndDims(coordX: int, coordY: int, width: int, height: int): SfDxutDialog;
    ...
    * https://library.sannybuilder.com/#/sa?q=SF_DXUT_DIALOG_SET_SLIDER_VALUE [0B98]*/
    setSliderValue(id: int, value: int): SfDxutDialog;
    ...
    * https://library.sannybuilder.com/#/sa?q=SF_DXUT_DIALOG_SET_TITLE_VISIBILITY [0B9F]*/
    setTitleVisibility(isVisible: boolean): SfDxutDialog;
    ...
    * https://library.sannybuilder.com/#/sa?q=SF_DXUT_DIALOG_SET_VISIBILITY_OF_CONTROL [0B90]*/
    setVisibilityOfControl(controlId: int, isVisible: int): SfDxutDialog;
...
interface SfScript {
    ...
    * https://library.sannybuilder.com/#/sa?q=SF_SET_SCRIPT_LOCAL_VARIABLE [0C6C]*/
    setLVar(varIndex: int, value: unknown): void;
...
declare class SfTimer {
    ...
    * https://library.sannybuilder.com/#/sa?q=SF_CREATE_TIMER [0C74]*/
    static Create(interval: int, callback: int): SfTimer | undefined;
...
interface Sprite {
    /** Draws a 2D sprite with texture, rectangle corners, RGBA color and rotation angle
    *
    * https://library.sannybuilder.com/#/sa?q=DRAW_2D_SPRITE [0D7E]*/
    ...
    /** Draws a 2D sprite with per-vertex colors (gradient) using texture and rectangle
    *
...
interface Streaming {
    ...
    * https://library.sannybuilder.com/#/sa?q=GET_MODEL_TYPE [0E7F]*/
    GetModelType(model: int): import('./enums').ModelInfoType;
    /** Gets the display name of a vehicle model (e.g. 'INFERNUS')
    *
    * https://library.sannybuilder.com/#/sa?q=GET_NAME_OF_VEHICLE_MODEL [0ADB]*/
...
interface Text {
    ...
    * https://library.sannybuilder.com/#/sa?q=CLEAR_THIS_PRINT_BIG_NOW [0A0E]*/
    ...
    /** Checks if one text string contains another (substring search)
    *
    ...
    * https://library.sannybuilder.com/#/sa?q=DRAW_STRING [0E62]*/
    DrawString(string: string, drawEvent: import('./enums').DrawEvent, posX: float, posY: float, sizeX: float, sizeY: float, fixAr: boolean, font: import('./enums').Font): void;
    ...
    * https://library.sannybuilder.com/#/sa?q=DRAW_STRING_EXT [0E63]*/
    DrawStringExt(string: string, drawEvent: import('./enums').DrawEvent, posX: float, posY: float, sizeX: float, sizeY: float, fixAr: boolean, font: import('./enums').Font, prop: boolean, align: import('./enums').Align, wrap: float, justify: boolean, red: int, green: int, blue: int, alpha: int, edge: int, shadow: int, dropRed: int, dropGreen: int, dropBlue: int, dropAlpha: int, background: boolean, backRed: int, backGreen: int, backBlue: int, backAlpha: int): void;
    ...
    * https://library.sannybuilder.com/#/sa?q=DRAW_SUBTITLES_BEFORE_FADE [0A2C]*/
    ...
    /** Checks if one text string ends with a given suffix
    *
    ...
    * https://library.sannybuilder.com/#/sa?q=GET_STRING_WIDTH_WITH_NUMBER [0A08]*/
    ...
    /** Checks if a text string variable is empty (zero-length)
    *
    ...
    * https://library.sannybuilder.com/#/sa?q=IS_THIS_HELP_MESSAGE_BEING_DISPLAYED [0A2A]*/
    ...
    /** Loads custom text entries from a FXT file
    *
    ...
    * https://library.sannybuilder.com/#/sa?q=REMOVE_TEXT_LABEL [0AE0]*/
    ...
    /** Scans/parses a string using sscanf-style format and stores the parsed values
    *
    ...
    * https://library.sannybuilder.com/#/sa?q=SET_TEXT_WRAPX [0343]*/
    ...
    /** Checks if one text string starts with a given prefix
    *
    ...
    * https://library.sannybuilder.com/#/sa?q=STRING_FIND [0EC4]*/
    StringFind(stringFind: import('./enums').StringFind, stringOrigin: string, strFind: string): int | undefined;
    /** Converts a float value to a string with format specifier
    *
    * https://library.sannybuilder.com/#/sa?q=STRING_FLOAT_FORMAT [0AED]*/
    StringFloatFormat(number: float, format: string): string;
    /** Formats a string with printf-style arguments and stores the result in a variable
    *
    * https://library.sannybuilder.com/#/sa?q=STRING_FORMAT [0AD3]*/
    StringFormat(result: string, format: string, ...args: number[]): void;
    /** Unloads custom text entries loaded from a FXT file
    *
...
interface Texture {
    /** Loads a texture from a BMP file, optionally with a separate mask file for alpha channel
    *
    * https://library.sannybuilder.com/#/sa?q=LOAD_TEXTURE_FROM_BMP_FILE [0D61]*/
    LoadFromBmpFile(bmp: string, mask: string): unknown | undefined;
    /** Loads a texture from a DDS file
    *
    * https://library.sannybuilder.com/#/sa?q=LOAD_TEXTURE_FROM_DDS_FILE [0D7C]*/
    LoadFromDdsFile(dds: string): unknown | undefined;
    /** Loads a texture from a PNG file
    *
    * https://library.sannybuilder.com/#/sa?q=LOAD_TEXTURE_FROM_PNG_FILE [0D64]*/
    LoadFromPngFile(png: string): unknown | undefined;
    /** Unloads/frees a previously loaded texture from memory
    *
...
interface Txd {
    ...
    * https://library.sannybuilder.com/#/sa?q=DRAW_TEXTURE_PLUS [0E1E]*/
    DrawTexturePlus(rwTextureOrSprite: int, drawEvent: import('./enums').DrawEvent, posX: float, posY: float, sizeX: float, sizeY: float, angle: float, depth: float, fixAr: boolean, maskVertCount: int, maskVertArray: int, red: int, green: int, blue: int, alpha: int): void;
    /** Returns the rwTexture pointer from sprite index
    *
    * https://library.sannybuilder.com/#/sa?q=GET_TEXTURE_FROM_SPRITE [0E3C]*/
    GetTextureFromSprite(spriteSlot: int): int;
...
interface Weapon {
    ...
    * https://library.sannybuilder.com/#/sa?q=GET_WEAPONINFO [0E84]*/
    GetWeaponInfo(weaponType: import('./enums').WeaponType, weaponSkill: import('./enums').WeaponSkill): WeaponInfo | undefined;
    /** Checks if the weapon has the specified fire type
    *
    * https://library.sannybuilder.com/#/sa?q=IS_WEAPON_FIRE_TYPE [0E26]*/
    IsFireType(weaponType: import('./enums').WeaponType, weaponFire: import('./enums').WeaponFire): boolean;
}
...
interface WeaponInfo {
    ...
    * https://library.sannybuilder.com/#/sa?q=GET_WEAPONINFO_ANIMGROUP [0E87]*/
    getAnimgroup(): import('./enums').AnimGrp;
    /** Returns the FireType of the current weaponInfo struct
    *
    * https://library.sannybuilder.com/#/sa?q=GET_WEAPONINFO_FIRE_TYPE [0E89]*/
    getFireType(): import('./enums').WeaponFire;
    ...
    * https://library.sannybuilder.com/#/sa?q=GET_WEAPONINFO_SLOT [0E8A]*/
    getSlot(): import('./enums').WeaponSlot;
...
interface Weather {
    ...
    * https://library.sannybuilder.com/#/sa?q=SET_NEXT_WEATHER [0E05]*/
    SetNext(type: import('./enums').WeatherType): void;
...
interface World {
    ...
    * https://library.sannybuilder.com/#/sa?q=GET_PICKUP_THIS_COORD [0E33]*/
    ...
    /** Finds a random vehicle within a sphere, returns handle and true if found
    *
    * https://library.sannybuilder.com/#/sa?q=GET_RANDOM_CAR_IN_SPHERE_NO_SAVE_RECURSIVE [0AE2]*/
    ...
    * https://library.sannybuilder.com/#/sa?q=GET_RANDOM_CHAR_IN_SPHERE_NO_BRAIN [08E5]*/
    ...
    /** Finds a random character within a sphere, returns handle and true if found
    *
    * https://library.sannybuilder.com/#/sa?q=GET_RANDOM_CHAR_IN_SPHERE_NO_SAVE_RECURSIVE [0AE1]*/
    GetRandomCharInSphereNoSaveRecursive(x: float, y: float, z: float, radius: float, findNext: boolean, filter: import('./enums').CharSearchFilter): Char | undefined;
    ...
    * https://library.sannybuilder.com/#/sa?q=GET_RANDOM_CHAR_IN_SPHERE_ONLY_DRUGS_BUYERS [089E]*/
    ...
    /** Finds a random object within a sphere, returns handle and true if found
    *
    * https://library.sannybuilder.com/#/sa?q=GET_RANDOM_OBJECT_IN_SPHERE_NO_SAVE_RECURSIVE [0AE3]*/
    ...
    * https://library.sannybuilder.com/#/sa?q=GET_SOUND_LEVEL_AT_COORDS [0855]*/
    ...
    /** Gets the 3D world coordinates of the target blip on the radar
    *
...
declare class AudioStream3D extends AudioStream {
    ...
    * https://library.sannybuilder.com/#/sa?q=SET_PLAY_3D_AUDIO_STREAM_AT_COORDS [0AC2]*/
    ...
    /** Attaches a 3D audio stream to an object's position
    *
    * https://library.sannybuilder.com/#/sa?q=SET_PLAY_3D_AUDIO_STREAM_AT_OBJECT [0AC3]*/
    ...
    /** Sets the spatial source size for a 3D audio stream
    *
